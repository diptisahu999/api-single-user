...
def relay_data_dimmer(m, id):
    logging.info("...................Dimmer lights status updating...................")
    array = []
    cn = 1
    for i in m:
        if(i == '64'):
            ...
            array.append({'device_id': id, 'channel_id': str(cn), 'device_status' : 'false',})
             ...
             operation = int(i, 16)
             array.append({'device_id': id, 'channel_id': str(cn), 'device_status' : str(operation)})
        cn += 1
    # print(array,"Dimmer------------------------------updated status")
    return array
...
param = {'device_id': 3, 'channel_id': str(18), 'device_status' : str(10)}
